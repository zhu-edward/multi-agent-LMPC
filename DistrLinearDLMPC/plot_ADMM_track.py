...
filehandler = open('track_object.pkl', 'rb')
#filehandler = codecs.open('lmpc_object.pkl', 'r', encoding='ISO-8859-1')
track = pickle.load(filehandler)


track[0][0].xADMM1_track
track[0][0].uADMM1_track
track[0][0].aADMM1_track
